...
#Los de la puerta
G.add_edge('P1','12',weight=9, label='', tipoEnlace = 'escalera', longitud = '9', inclinacion = '+', barandilla = '', ocupacion = '' )
G.add_edge('P1','14',weight=9, label='', tipoEnlace = 'escalera', longitud = '9', inclinacion = '+', barandilla = '', ocupacion = '' )
